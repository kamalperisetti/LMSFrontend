...
// //   let student = parsedData.UserDetails;
// //   // const student = useAppSelector((state: any) => state.adminDetails.user);

// //   // console.log(student, "KILLLLL");
// //   // setStudent(parsedData.UserDetails);
// //   // useEffect(() => {
// //   //   fetchUpdatedStudentData();
// //   // });
// //   const navigate = useNavigate();
// //   const dispatch = useAppDispatch();
// //   const studentProgress = student.studentsCompleted;

// //   console.log(parsedData.UserDetails, "JILLLLLL");
// //   console.log(student.studentId, "HEEEE WILL BE MEEEE");
// //   const token = Cookies.get("jwt_token");

// //   const fetchUpdatedStudentData = async () => {
// //     try {
// //       const url = `https://lmsbackend-fhsd.onrender.com/userbyid/${student.studentId}`;
...
// //     const progress: Progress = studentProgress.find(
