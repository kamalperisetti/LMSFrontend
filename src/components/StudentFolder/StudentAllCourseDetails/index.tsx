...
//   const data = useAppSelector((state: any) => state.courseDetails.course);
//   const student = useAppSelector((state: any) => state.adminDetails.user);
//   const studentId = student.studentId;
//   const location = useLocation();

//   console.log(data, "AMOOOO");
...
//     }
//   };
//   const onClickCompleted = (isCompleted: any) => {
//     if (!isCompleted) {
...
//             <ul>
//               {courseData.courseDetails.map((each: any) => (
